...
void SimAnalyzer::analyze(const edm::Event& iEvent, const edm::EventSetup& setup)
{
  ++n_event;
  ...
  for( edm::View<reco::GenParticle>::const_iterator iGenp = genParticles.begin(); 
	...
	vector_pt = iGenp->pt();
// 	std::cout << "W pt = " << vector_pt << std::endl;
// 	std::cout << "W status = " << iGenp->status() << std::endl;
