...
process.SimAnalyzer = cms.EDAnalyzer("SimAnalyzer",
                                        genPart     = cms.untracked.InputTag("genParticles"),
                                        )

process.TFileService = cms.Service("TFileService", fileName = cms.string('SimAnalyzer_WJets.root'))

process.p = cms.Path(process.SimAnalyzer)
