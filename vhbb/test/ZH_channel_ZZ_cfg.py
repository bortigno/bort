...
process.load('VHbb.iCode.ZH_channel_ZZ_v7_cfi')
...
#     #merged file v2
# #    'file:////scratch/bortigno/ZH_channel_v2_ZZ.root'

#     #merged file v5
# #    'file:////scratch/bortigno/ZMuMu_channel_v5_ZZ.root'

#     #merged file v6
#     'file:////scratch/bortigno/ZMuMu_channel_v6_ZZ.root'
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('ZH_channel_v7/ZH_channel_ZZ/ZMuMu_channel_v17_ZZ.root'))
