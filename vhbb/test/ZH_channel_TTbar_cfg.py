...
process.load('VHbb.iCode.ZH_channel_TTbar_v7_cfi')
...
#     #merged file v2
# #    'file:////scratch/bortigno/ZH_channel_v2_TTbar.root'

#     #merged file v5
# #    'file:////shome/bortigno/CMSSW_3_8_6/src/VHbb/iCode/test/ZH_channel_v5/ZH_channel_TTbar/res/ZMuMu_channel_v5_TTbar.root'

#         #merged file v6
#     'file:////scratch/bortigno/ZMuMu_channel_v6_TTbar.root'
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('ZH_channel_v7/ZH_channel_TTbar/ZMuMu_channel_v17_TTbar.root'))
