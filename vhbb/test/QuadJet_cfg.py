...
process.TFileService = cms.Service("TFileService", fileName = cms.string('QuadJet.root'))

process.p = cms.Path( process.patDefaultSequence * process.QuadJet )
