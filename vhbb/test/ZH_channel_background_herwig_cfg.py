...
#                            eventsToProcess = cms.untracked.VEventRange('1:90520'),
    ...
    # ZH_channel background herwig merged v0
#    '/store/user/bortigno/ZH_channel/ZH_channel_background_herwig/selectedEvents/merge-selected_background_herwig_ZH.root'

    # ZH_channel background herwig merged v1
    'file:///scratch/bortigno/ZH_channel_v1_background_herwig.root'
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('ZH_channel_background_herwig_v4.root'))
