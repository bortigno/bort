...
process.load('VHbb.iCode.ZH_channel_ZJets_v7_cfi')
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('ZH_channel_v7/ZH_channel_ZJets/ZMuMu_channel_v17_ZJetsHerwig.root'))
