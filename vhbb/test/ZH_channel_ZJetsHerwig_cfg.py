...
#                            eventsToProcess = cms.untracked.VEventRange('1:90520'),
    ...
    #merged file v2
#    'file:////scratch/bortigno/ZH_channel_v2_ZJetsHerwig.root'

    #merged file v5
#    'file:////scratch/bortigno/ZMuMu_channel_v5_ZJets_herwig.root'

    #merged file v6
    'file:////scratch/bortigno/ZMuMu_channel_v6_ZJetsHerwig.root'
...
process.TFileService = cms.Service("TFileService", fileName = cms.string('ZH_channel_v6/ZH_channel_ZJets_herwig/ZMuMu_channel_v17_ZJetsHerwig.root'))
