// This is to see the results of the ZH_channel.cxx in version 6 analyzer v16
...
int Ntuple_viewer_run_v6( void ){
  ...
  Double_t helicityCut = 0.7;
  Double_t leadingDeltaThetaCut = 1.8;
  Double_t jetPtAsymmetryCut = 1;
  Double_t higgsLowerMassCut = 100;
  Double_t higgsHigherMassCut = 140;
  ...
  Ntuple_viewer VH("ZH_channel_v6/ZH_channel_ZH/ZMuMu_channel_v17_ZH.root");
  ...
  for (unsigned int i = 0; i < entries; ++i){
    ...
    if( VH.higgsCandidate_mass > 100 
	and VH.higgsCandidate_mass < 140 )
      VH_counter++;
  ...
  Ntuple_viewer VJ("ZH_channel_v6/ZH_channel_ZJets_herwig/ZMuMu_channel_v17_ZJetsHerwig.root");
  ...
  for (unsigned int i = 0; i < entries; ++i){
    ...
    if( VJ.higgsCandidate_mass > 100 
	and VJ.higgsCandidate_mass < 140 )
      VJ_counter++;
  ...
  Ntuple_viewer TTbar("ZH_channel_v6/ZH_channel_TTbar/ZMuMu_channel_v17_TTbar.root");
  ...
  for (unsigned int i = 0; i < entries; ++i){
    ...
    if( TTbar.higgsCandidate_mass > 100 
	and TTbar.higgsCandidate_mass < 140 )
      TTbar_counter++;
  ...
  Ntuple_viewer VV("ZH_channel_v6/ZH_channel_ZZ/ZMuMu_channel_v17_ZZ.root");
  ...
  for (unsigned int i = 0; i < entries; ++i){
    ...
    if( VV.higgsCandidate_mass > 100 
	and VV.higgsCandidate_mass < 140 )
      VV_counter++;
