...
void prepareAllZHistos(std::vector<CutsAndHistos *> & allHistosZ,TFile *fout  )
{
  ...
  for(int j=0; j<2; ++j){ // jec systematics
    //Standard histos
    allHistosZ.push_back(new CutsAndHistos(new BDTTTbarControlRegionHZcombSB( jec[j], 0 ),new StandardHistos));
    allHistosZ.push_back(new CutsAndHistos(new BDTZlightControlRegionHZcombSB( jec[j] , 0 ),new StandardHistos));
    allHistosZ.push_back(new CutsAndHistos(new BDTSideBandRegionHZcombSB( jec[j], 0 ),new StandardHistos));
    allHistosZ.push_back(new CutsAndHistos(new BDTTrainingRegionHZcombSB( jec[j], 0 ),new StandardHistos));
    allHistosZ.push_back(new CutsAndHistos(new BDTZbbControlRegionHZcombSB( jec[j], 0 ),new StandardHistos));
    //Systematics histos
    allHistosZ.push_back(new CutsAndHistos(new BDTTTbarControlRegionHZcombSB( jec[j], 0 ),new SystematicsHistos));
    allHistosZ.push_back(new CutsAndHistos(new BDTZlightControlRegionHZcombSB( jec[j] , 0 ),new SystematicsHistos));
    allHistosZ.push_back(new CutsAndHistos(new BDTSideBandRegionHZcombSB( jec[j], 0 ),new SystematicsHistos));
    allHistosZ.push_back(new CutsAndHistos(new BDTTrainingRegionHZcombSB( jec[j], 0 ),new SystematicsHistos));
    allHistosZ.push_back(new CutsAndHistos(new BDTZbbControlRegionHZcombSB( jec[j], 0 ),new SystematicsHistos));
  }
  
  for( int b=0; b<5; ++b){ //btag systematics
    //Standard histos
    allHistosZ.push_back(new CutsAndHistos(new BDTTTbarControlRegionHZcombSB( 0, btag[b] ),new StandardHistos));
    allHistosZ.push_back(new CutsAndHistos(new BDTZlightControlRegionHZcombSB( 0 , btag[b] ),new StandardHistos));
    allHistosZ.push_back(new CutsAndHistos(new BDTSideBandRegionHZcombSB( 0, btag[b] ),new StandardHistos));
    allHistosZ.push_back(new CutsAndHistos(new BDTTrainingRegionHZcombSB( 0, btag[b] ),new StandardHistos));
    allHistosZ.push_back(new CutsAndHistos(new BDTZbbControlRegionHZcombSB( 0, btag[b] ),new StandardHistos));
    //Systematics histos
    allHistosZ.push_back(new CutsAndHistos(new BDTTTbarControlRegionHZcombSB( 0, btag[b] ),new SystematicsHistos));
    allHistosZ.push_back(new CutsAndHistos(new BDTZlightControlRegionHZcombSB( 0 , btag[b] ),new SystematicsHistos));
    allHistosZ.push_back(new CutsAndHistos(new BDTSideBandRegionHZcombSB( 0, btag[b] ),new SystematicsHistos));
    allHistosZ.push_back(new CutsAndHistos(new BDTTrainingRegionHZcombSB( 0, btag[b] ),new SystematicsHistos));
    allHistosZ.push_back(new CutsAndHistos(new BDTZbbControlRegionHZcombSB( 0, btag[b] ),new SystematicsHistos));
  }
...
int main(int argc, char **argv)
{
  ...
  bool verbose_ = false;
  bool stitching = true;
  std::string file_appendix = "sideband";
