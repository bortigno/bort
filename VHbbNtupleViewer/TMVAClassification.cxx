...
//    float backgroundXsecTbar_tWDSchannel = 25;
   ...
   std::string modeZ("Z");
   std::string modeW("W");
   if( (channel.find(modeZ)==0) or (channel.find(modeZ)==0) or (channel.find(modeZ)==0) ){
     myInputFile_signal.push_back(TFile::Open((path+"TestZH_ZToLL_HToBB_M-115_7TeV-powheg-herwigpp.root").c_str()));
     signalXsec = xSecZH;
   }
   //signal for W
   if( (channel.find(modeW)==0) or (channel.find(modeW)) ){
     myInputFile_signal.push_back(TFile::Open((path+"TestZH_ZToLL_HToBB_M-115_7TeV-powheg-herwigpp.root").c_str()));
     signalXsec = xSecWH;
   }
   //background
   myInputFile_background.push_back(TFile::Open((path+"TestDYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola.root").c_str()));
   backgroundXsec.push_back(backgroundXsecDY);
   myInputFile_background.push_back(TFile::Open((path+"TestWJetsToLNu_TuneZ2_7TeV-madgraph-tauola.root").c_str()));
   backgroundXsec.push_back(backgroundXsecWJets);
   myInputFile_background.push_back(TFile::Open((path+"TestTTJets_TuneZ2_7TeV-madgraph-tauola.root").c_str()));
   backgroundXsec.push_back(backgroundXsecTT);
   myInputFile_background.push_back(TFile::Open((path+"TestT_TuneZ2_t-channel_7TeV-powheg-tauola.root").c_str()));
   backgroundXsec.push_back(backgroundXsecT_tchannel);
   myInputFile_background.push_back(TFile::Open((path+"TestT_TuneZ2_tW-channel-DR_7TeV-powheg-tauola.root").c_str()));
   backgroundXsec.push_back(backgroundXsecT_tWDRchannel);
   myInputFile_background.push_back(TFile::Open((path+"TestTbar_TuneZ2_t-channel_7TeV-powheg-tauola.root").c_str()));
   backgroundXsec.push_back(backgroundXsecTbar_tchannel);
   myInputFile_background.push_back(TFile::Open((path+"TestTbar_TuneZ2_tW-channel-DR_7TeV-powheg-tauola.root").c_str()));
   backgroundXsec.push_back(backgroundXsecTbar_tWDRchannel);
   //      myInputFile_background.push_back(TFile::Open((path+"TestTbar_TuneZ2_tW-channel-DS_7TeV-powheg-tauola.root").c_str()));
   //      backgroundXsec.push_back(backgroundXsecTbar_tWDSchannel);
   myInputFile_background.push_back(TFile::Open((path+"TestWZ_TuneZ2_7TeV_pythia6_tauola.root").c_str()));
   backgroundXsec.push_back(backgroundXsecWZ);
   myInputFile_background.push_back(TFile::Open((path+"TestWW_TuneZ2_7TeV_pythia6_tauola.root").c_str()));
   backgroundXsec.push_back(backgroundXsecWW);
   myInputFile_background.push_back(TFile::Open((path+"TestZZ_TuneZ2_7TeV_pythia6_tauola.root").c_str()));
   backgroundXsec.push_back(backgroundXsecZZ);


   if(channel == "ZeeLightCC"){
     factory->AddVariable( "H_mass", "bb mass"      , "GeV/c2", 'F' );
     factory->AddVariable( "V_mass", "vector mass" , "GeV/c2", 'F' );
     factory->AddVariable( "H_pt", "bb pt"        , "GeV/c" , 'F' );
     factory->AddVariable( "V_pt", "vector pt"  , "GeV/c" , 'F' );
     factory->AddVariable( "hJet_csv[0]", "btag1"        , "csv"   , 'F' );
     factory->AddVariable( "hJet_csv[1]", "btag2"        , "csv"   , 'F' );
     factory->AddVariable( "HVdPhi", "DeltaPhi(V,H)"    , ""  , 'F' );
     factory->AddVariable( "H_dEta", "DeltaEta(b,b)"     , "" , 'F' );

     //PRESELECTION
     mycuts="Vtype == 1 &&  V_mass > 75. && V_mass < 105. && V_pt > 100.  && H_pt > 100. && hJet_pt[0] > 20. && hJet_pt[1] > 20. && EVENT_json == true && Sum$(aJet_pt > 20. && fabs(aJet_eta) < 2.4 ) > 1";
   }
   else if(channel == "ZeeTTbarCC"){
     factory->AddVariable( "H_mass", "bb mass"      , "GeV/c2", 'F' );
     factory->AddVariable( "V_mass", "vector mass" , "GeV/c2", 'F' );
     factory->AddVariable( "H_pt", "bb pt"        , "GeV/c" , 'F' );
     factory->AddVariable( "V_pt", "vector pt"  , "GeV/c" , 'F' );
     ...
     //PRESELECTION
     mycuts="Vtype == 1 && V_mass > 120. && V_pt > 0. && H_pt > 0. && hJet_pt[0] > 20. && hJet_pt[1] > 20. && EVENT_json == true && MET_et > 50 ";
   }
   else if(channel == "ZeeHeavyCC"){
     factory->AddVariable( "H_mass", "bb mass"      , "GeV/c2", 'F' );
     factory->AddVariable( "V_mass", "vector mass" , "GeV/c2", 'F' );
     factory->AddVariable( "H_pt", "bb pt"        , "GeV/c" , 'F' );
     factory->AddVariable( "V_pt", "vector pt"  , "GeV/c" , 'F' );
     ...
     //PRESELECTION
     mycuts="Vtype == 1 && V_mass > 75. && V_mass < 105. && V_pt > 0. && H_pt > 0. && hJet_pt[0] > 20. && hJet_pt[1] > 20. && hJet_csv[0] > 0.898 && hJet_csv[1] > 0.898 && EVENT_json == true && Sum$(aJet_pt > 20. && fabs(aJet_eta) < 2.4 ) < 2 && ( H_mass < 90 || H_mass > 145 ) && TMath::Abs(HVdPhi) > 2.9";
   }
   else if(channel == "ZeeBDTCC"){
     factory->AddVariable( "H.mass", "bb mass"      , "GeV/c2", 'F' );
     factory->AddVariable( "H.pt", "bb pt"        , "GeV/c" , 'F' );
     factory->AddVariable( "H.dEta", "DeltaEta(b,b)"     , "" , 'F' );
     factory->AddVariable( "HVdPhi", "DeltaPhi(V,H)"    , ""  , 'F' );
     factory->AddVariable( "V.mass", "vector mass" , "GeV/c2", 'F' );
     factory->AddVariable( "V.pt", "vector pt"  , "GeV/c" , 'F' );
     factory->AddVariable( "hJet_csv[0]", "btag1"        , "csv"   , 'F' );
     factory->AddVariable( "hJet_csv[1]", "btag2"        , "csv"   , 'F' );
     //PRESELECTION
     mycuts="hJet_pt[0] > 20. && hJet_pt[1] > 20. && hJet_csv[0] > 0.244 && hJet_csv[1] > 0.244 && H.pt > 100. && V.pt > 100. && Sum$(aJet_pt > 20 && abs(aJet_eta) < 2.4) < 2. && V.mass > 75. && V.mass < 105 && Vtype == 1";
   }


   factory->SetSignalWeightExpression( "PUweight*weightTrig" );
   factory->SetBackgroundWeightExpression( "PUweight*weightTrig" );
   ...
   for(unsigned int i = 0; i < myInputFile_signal.size(); ++i ){
     ...
     samples_signal.push_back(Sample(signalXsec,"signal", name , kRed,false));
     TTree * tmpTree = (TTree*)myInputFile_signal.at(i)->Get("tree");
   ...
   for(unsigned int i = 0; i < myInputFile_background.size(); ++i ){
     ...
     samples_background.push_back(Sample(backgroundXsec.at(i),"background", name ,i+10,false));
     TTree * tmpbackTree = (TTree*)myInputFile_background.at(i)->Get("tree");
...
// 			  "!H:!V:NTrees=850:nEventsMin=150:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:SeparationType=GiniIndex:nCuts=20:PruneMethod=NoPruning" );
			  "!H:!V:NTrees=200:nEventsMin=100:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:SeparationType=GiniIndex:nCuts=20:PruneMethod=NoPruning" );
