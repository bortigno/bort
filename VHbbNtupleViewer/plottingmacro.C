...
void plottingmacro()
{
  ...
  //  std::string path("Nov10Fall1160MTopSlimZbbXsecPlots/");
  ...
  //  std::vector<Sample> s = Nov10Fall1160MTopSlimZbbXsecHistos();
  ...
  for(size_t i = 0 ; i < names.size() ; i++) 
    {
      ...
      //      if(!n.Contains(TRegexp("BDTRegionHZee"))) continue;
      if(!n.Contains(TRegexp("BDT"))) continue;
      //      if(!n.Contains(TRegexp("Signal"))) continue;
