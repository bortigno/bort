...
#GammaZ
'file:///shome/bortigno/CMSSW_4_1_3_patch3/src/GammaJets/MG4/GammaZ_RECO_test/res/GammaZ_RAW2DIGI_L1Reco_RECO_VALIDATION_DQM_PU_1_1_FMZ.root'
#NovReReco
...
#                 jetCorrLabel=('AK7PF', 'L3Absolute'),
                 jetCorrLabel=('AK7PF', ['L1FastJet','L2Relative','L3Absolute']),
                 doType1MET=False,
                 doL1Cleaning=False,
                 doL1Counters=False,
...
# Filter agains PKAM (Previously Known As Monster) eventi in cui hai una shower longitudinale nel tracker
...
#                                   pfMetCand              = cms.untracked.InputTag("pfMet"),
                                  ...
                                  hltPath                 = cms.InputTag("TriggerResults"),
...
process.p = cms.Path(  process.scrapingVeto * process.oneGoodVertexFilter * process.HBHENoiseFilter * process.fjSequence * process.patDefaultSequence * process.GammaJet )
